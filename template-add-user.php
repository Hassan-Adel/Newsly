            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="dash.php" class="logo"><i class="md md-terrain"></i> <span>Moltran </span></a>
                    </div>
                </div>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            <li>
                                <a href="dash.php" class="waves-effect"><i class="md md-home"></i><span> Dashboard </span></a>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <?php if($_SESSION['privilege']=="1" || $_SESSION['privilege']=="5"){ ?>
                                    <li><a href="form-elements.php">Add form</a></li>
									<?php } 
									?>
										...
										<div style="margin-left: 100px;" class="checkbox checkbox-primary">
                                            ...
                                            <div class="form-group m-b-0">
                                                <div class="col-sm-offset-3 col-sm-9">
                                                  <button type="submit" name = "AddUser" class="btn btn-info waves-effect waves-light">Add</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div> <!-- panel-body -->
